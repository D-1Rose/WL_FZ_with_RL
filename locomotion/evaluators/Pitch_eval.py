...
# [修改2] 定义自动化指令序列
    ...
    test_schedule = [
        (0.0,   0.1,  [vel,  0.0, 0.0, 0.28]),   # 0-10s:  向前走
        (0.1,   0.5,  [vel,  0.0, 0.0, 0.28]),   # 0-10s:  向前走
        (0.5,   0.8,  [vel,  0.0, 0.0, 0.28]),   # 0-10s:  向前走
