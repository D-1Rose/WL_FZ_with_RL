...
class LQR_Controller:
    def __init__(self, model):
        ...
        self.command_pitch = PIDController(kp=15, ki=0.0, kd=2.0, output_limit=100.0) # 平衡是大头
                                            # kp=25, ki=0, kd=0
        self.command_velocity = PIDController(kp=0.35, ki=0.001, kd=0, output_limit=100.0) # 速度不要抢占太多力矩
                                            # kp=1, ki=0, kd=0
    ...
    def get_command_pitch(self, data):
        ...
        self.theta_pitch = pitch_ref_from_vel - self.pitch
        # self.pitch_d = 0
        # theta_pitch = self.pitch_d - (self.pitch + 0)
