...
# 导入你自己的控制器模块
from utils.Sim_mj_keyboard import KeyboardCommander
from environments.Sim_mj import VMC, LQR_Controller
...
def main():
    ...
    # 1. 加载模型
    model = mujoco.MjModel.from_xml_path("/home/huang/wheel_leg/wheel_legged_genesis_new/assets/description/scence_Sim.xml")
