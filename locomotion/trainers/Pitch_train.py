...
from environments.Pitch_env import WheelLeggedEnv
...
def get_cfgs():
    ...
    obs_cfg = {
        ...
        "num_obs": 29*6, #在rsl-rl中使用的变量为num_obs表示state数量
        "num_slice_obs": 29,
        "history_length": 5,
        "obs_scales": {
            "lin_vel": 1,
        ...
        "noise":{
            "use": True,
            #[高斯,随机游走]
            "ang_vel": [0.00001,0.000011],
            "dof_pos": [0.000001,0.000005],
            "dof_vel": [0.000001,0.000005],
            "gravity": [0.000001,0.00002],
            "base_euler": [0.000001,0.000005],
        }
    }
    reward_cfg = {
        "tracking_lin_sigma": 0.15,
        "inner_pitch_sigma": 0.13,   
        "action_rate_sigma": 0.1,
        
        "reward_scales": {
            # 核心目标：速度追踪和姿态维持
            "tracking_lin_vel": 5.0,     
            "inner_pitch_error": 5.0,   
            # [删除] "inner_pitch_convergence": 5.0  (波浪地不可能单调收敛)
    ...
    command_cfg = {
        ...
        "sampling_weights": [1, 0.0, 0.0, 0.0], 
        # 你指定的 4 个核心测试速度
